...
import don.juan.matus.lib.tree.bintree.rotatetree.scapegoat.ScapegoatTree;
import don.juan.matus.lib.tree.bintree.rotatetree.splay.SplayTree;
import don.juan.matus.lib.tree.bintree.rotatetree.waight.BinTreeW;
import don.juan.matus.lib.tree.bintree.tst.TreeMapTst;
import don.juan.matus.lib.tree.bintree.tst.TreeSetTst;
...
//            System.out.print(", " + rnd);
    ...
    private List<Long> readRendomDataFile() throws IOException, ClassNotFoundException {
        List<Long> result;
        ObjectInputStream is = new ObjectInputStream(new FileInputStream("src/test/resources/RandomDataFile.dat"));
