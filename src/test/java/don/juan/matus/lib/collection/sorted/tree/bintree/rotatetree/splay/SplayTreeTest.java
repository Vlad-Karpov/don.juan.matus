...
public class SplayTreeTest extends TestCase {
    ...
    public void testRemove() {
        ...
        btLng.removeNode(false, BinTreeInterface.seekLoop(2L, btLng.getRoot()), null, null);
        btLng.removeNode(false, BinTreeInterface.seekLoop(3L, btLng.getRoot()), null, null);
        btLng.removeNode(false, BinTreeInterface.seekLoop(8L, btLng.getRoot()), null, null);
        ...
        btLng.removeNode(false, BinTreeInterface.seekLoop(13L, btLng.getRoot()), null, null);
        btLng.removeNode(false, BinTreeInterface.seekLoop(9L, btLng.getRoot()), null, null);
        btLng.removeNode(false, BinTreeInterface.seekLoop(18L, btLng.getRoot()), null, null);
        item = btLng.getRoot().getLeft();
        assertEquals("Must bu 17!", 17L, item.getObjectNode().longValue());
        assertEquals("Must bu 16!", 16L, item.getLeft().getObjectNode().longValue());
        assertEquals("Must bu 19!", 19L, item.getRight().getObjectNode().longValue());
        btLng.removeNode(false, BinTreeInterface.seekLoop(11L, btLng.getRoot()), null, null);
        item = btLng.getRoot().getLeft();
        ...
        btLng.removeNode(false, BinTreeInterface.seekLoop(10L, btLng.getRoot()), null, null);
        item = btLng.getRoot().getLeft();
        assertEquals("Must bu 7!", 7L, item.getObjectNode().longValue());
        assertEquals("Must bu 1!", 1L, item.getLeft().getObjectNode().longValue());
        assertEquals("Must bu 16!", 16L, item.getRight().getObjectNode().longValue());
        btLng.removeNode(false, BinTreeInterface.seekLoop(12L, btLng.getRoot()), null, null);
        assertEquals("Must bu 7!", 7L, item.getObjectNode().longValue());
        assertEquals("Must bu 1!", 1L, item.getLeft().getObjectNode().longValue());
        assertEquals("Must bu 16!", 16L, item.getRight().getObjectNode().longValue());
        ...
        btLng.removeNode(false, BinTreeInterface.seekLoop(20L, btLng.getRoot()), null, null);
        item = btLng.getRoot().getLeft();
