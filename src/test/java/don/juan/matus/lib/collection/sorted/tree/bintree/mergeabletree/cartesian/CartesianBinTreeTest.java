...
import don.juan.matus.lib.collection.sorted.tree.bintree.MergeableBinTree;
...
public class CartesianBinTreeTest extends TestCase {
    ...
    private BinTreeNodeWithPriorityInNode<Long> someMerge() {
        ...
        BinTreeNodeWithPriorityInNode<Long> leftTree = new BinTreeNodeWithPriorityInNode<Long>(null, 2L, null, null, null);
        leftTree.setPriority(10.0d);
        leftTree.setLeft(new BinTreeNodeWithPriorityInNode<>(null, 1L, null, leftTree, null));
        ((BinTreeNodeWithPriorityInNode<Long>) leftTree.getLeft()).setPriority(9.0d);
        leftTree.setRight(new BinTreeNodeWithPriorityInNode<>(null, 3L, null, leftTree, null));
        ((BinTreeNodeWithPriorityInNode<Long>) leftTree.getRight()).setPriority(8.0d);
        BinTreeNodeWithPriorityInNode<Long> rightTree = new BinTreeNodeWithPriorityInNode<Long>(null, 5L, null, null, null);
        rightTree.setPriority(7.0d);
        rightTree.setLeft(new BinTreeNodeWithPriorityInNode<>(null, 4L, null, rightTree, null));
        ((BinTreeNodeWithPriorityInNode<Long>) rightTree.getLeft()).setPriority(6.0d);
        rightTree.setRight(new BinTreeNodeWithPriorityInNode<>(null, 6L, null, rightTree, null));
