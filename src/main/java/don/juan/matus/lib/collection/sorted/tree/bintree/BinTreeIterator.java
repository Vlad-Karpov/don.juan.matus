 ...
 */
public class BinTreeIterator<T extends Comparable<? extends T>> extends BinTreeIteratorBase<T> {
    ...
    @Override
    public void remove() {
        currentNode = binTree.removeNode(false, removeNode, currentNode, null);
        removeNode = null;
    }
